...
* **Балансировка нагрузки:** Интеграция с Discovery Service (Consul) для распределения запросов между экземплярами сервисов.
...
* **Discovery Client:** Взаимодействие с Consul для динамического обнаружения адресов сервисов.
